...
def test_iris_transform_with_tree(iris_data):
    ...
    titles = ["basis", "extend", "full"]
    generate_combined_figure(embeddings, labelset, titles, "test_iris_transform_tree")
...
def test_iris_transform_without_tree(iris_data):
    ...
    labelset = [label, label, y]
    titles = ["basis", "extend", "full"]
    generate_combined_figure(embeddings, labelset, titles, "test_iris_transform")
