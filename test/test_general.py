...
def test_pacmap_small_dataset():
    ...
    _ = f.fit_transform(sample_small_data)
...
def test_pacmap_large_dataset():
    ...
    g = pacmap.PaCMAP()
    _ = g.fit_transform(sample_large_data)
...
def test_pacmap_same_dimensional_2d():
    ...
    h = pacmap.PaCMAP()
    _ = h.fit_transform(same_dimensional_data)
...
def test_pacmap_same_dimensional_3d():
    ...
    _ = h.fit_transform(three_dimensional_data)
